...
- ![Rust](https://img.shields.io/badge/rust-%23281c1c.svg?style=plastic&logo=rust&logoColor=fff) [way-edges](https://github.com/way-edges/way-edges) - An application providing off-screen widgets hidden along the edges of the screen, developed using `smithay-client-toolkit`
