...
> [!IMPORTANT]
> The scope of this repository aims to capture applications, libraries, etc. that are **designed** to support the Wayland ecosystem. This does not include existing applications that have implemented support for Wayland or applications that only invoke Wayland-based applications. That list is being maintained at [mpsq/arewewaylandyet](https://github.com/mpsq/arewewaylandyet) which is the repository for [arewewaylandyet.com](https://arewewaylandyet.com). An updated list is also available at [gianklug/wearewaylandnow](https://github.com/gianklug/wearewaylandnow) which is the repository for [wearewaylandnow.com](https://wearewaylandnow.com).
...
- ![Odin](https://img.shields.io/badge/odin-3882d2?style=plastic&logo=odin&logoColor=ffffff) [odin-wayland](https://github.com/yasinkaraaslan/odin-wayland) - Bindings for creating Wayland clients
...
- ![Java](https://img.shields.io/badge/java-%23ffffff.svg?style=plastic&logo=openjdk&logoColor=%23000000) [wlroots4j](https://github.com/klozovin/nylon/tree/master/wlroots4j) - Bindings for wlroots
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [mangowm](https://github.com/mangowm/mango) - A dwl-inspired Wayland compositor with lightweight animations and customizable layouts
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [vwl](https://github.com/wegel/vwl) - A simple wlroots-based Wayland compositor originally forked from dwl
...
- ![Go](https://img.shields.io/badge/go-%2300add8.svg?style=plastic&logo=go&logoColor=fff) [Hexecute](https://github.com/m31-galaxy/Hexecute) - A gesture-based launcher for wlroots-based Wayland compositors implementing the `wlr-layer-shell-unstable-v1` protocol
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff)&nbsp;![Scheme](https://img.shields.io/badge/scheme-%23000.svg?style=plastic) [lambdock](https://codeberg.org/jjba23/lambdock) - A configurable dock implementing the `gtk4-layer-shell` protocol for Wayland compositors implementing the `wlr-layer-shell-unstable-v1` protocol
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [shoyu](https://github.com/Midstall/shoyu) - A framework for wlroots-based, GTK-based Wayland implementations
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [still](https://github.com/faergeek/still) - A tool that freezes the screen until a provided command exits for wlroots-based Wayland compositors implementing the `wlr-layer-shell-unstable-v1` and `wlr-screencopy-unstable-v1` protocols
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [miru](https://codeberg.org/Vaishnav-Sabari-Girish/miru) - A Wayland-native screen magnifier implementing the `wlr-layer-shell-unstable-v1` and `wlr-screencopy-unstable-v1` protocols inspired by [boomer](https://github.com/tsoding/boomer)
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [btrbg](https://codeberg.org/julmajustus/btrbg) - A basic wallpaper application for Wayland compositors implementing the `wlr-layer-shell-unstable-v1` protocol
...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [neowall](https://github.com/1ay1/neowall) - A shader-based GPU-accelerated wallpaper engine for Wayland compositors implementing either the `kde-plasma-shell` or `wlr-layer-shell-unstable-v1` protocols
...
- ![C++](https://img.shields.io/badge/c++-%235e97d0.svg?style=plastic&logo=c%2B%2B&logoColor=fff) [waul](https://github.com/hoppxi/waul) - A minimalistic wallpaper daemon for Wayland compositors implementing the `wlr-layer-shell-unstable-v1` protocol
...
- ![Zig](https://img.shields.io/badge/zig-%23f7a41d.svg?style=plastic&logo=zig&logoColor=fff) [yin](https://github.com/SaverinOnRails/yin) - An efficient animated wallpaper daemon for wlroots-based Wayland compositors implementing the `wlr-layer-shell-unstable-v1` protocol
...
- ![Python](https://img.shields.io/badge/python-4584b6?style=plastic&logo=python&logoColor=ffde57) [animation-speech](https://github.com/rcspam/animation-speech) - A configurable transparent speech animation overlay for Wayland compositors implementing the `wlr-layer-shell-unstable-v1` and `gtk3-layer-shell` protocols
...
- ![Zig](https://img.shields.io/badge/zig-%23f7a41d.svg?style=plastic&logo=zig&logoColor=fff) [creek](https://github.com/nmeum/creek) - A dwm-inspired fork of levee and minimalist status bar for the river-classic compositor designed to be more malleable by allowing arbitrary text rather than built-in modules
...
- ![Python](https://img.shields.io/badge/python-4584b6?style=plastic&logo=python&logoColor=ffde57) [nwg-wrapper](https://github.com/nwg-piotr/nwg-wrapper) - A simple text-based wrapper that displays script or file output on the desktop of wlroots-based Wayland compositors implementing the `wlr-layer-shell-unstable-v1` and `gtk3-layer-shell` protocols
...
- [VORTEX BALL](https://iskillplay.web.app/vortex-ball.html)
...
- [AGENTS IO](https://themindplay.pages.dev/agents-io.html)
...
- [LABUBA MERGE](https://thequizzone.pages.dev/labuba-merge.html)
...
- [CATCH THE PIG](https://studyquesthub.web.app/catch-the-pig.html)
- [BUTTERFLY KYODAI RAINBOW](https://studyquests.pages.dev/butterfly-kyodai-rainbow.html)
- [TURBO RACE 3D](https://theskillquest.pages.dev/turbo-race-3d.html)
...
- [ZOMBIE RAFT](https://thequizzone.pages.dev/zombie-raft.html)
...
- [WAR LANDS](https://theskillquest.pages.dev/war-lands.html)
...
- [DICTATOR SIMULATOR 1984](https://theskillquest.pages.dev/dictator-simulator-1984.html)
- [BUTTERFLY TRIPLE](https://thequizzone.pages.dev/butterfly-triple.html)
- [RUN FRIENDS](https://thequizzone.pages.dev/run-friends.html)
- [UP HERO](https://thequizzone.pages.dev/up-hero.html)
...
- [DIVINEX](https://theskillquest.pages.dev/divinex.html)
...
- [LABUBU MERGE](https://thelearnquesters.pages.dev/labubu-merge.html)
- [LEVEL UP MUTANTS](https://thelearnquester.web.app/level-up-mutants.html)
- [INTERSTELLAR](https://thequizzone.pages.dev/interstellar.html)
...
- [CRAZY BUS STATION](https://thelearnquesters.pages.dev/crazy-bus-station.html)
...
- [SPRUNKI SPACE CHALLENGE](https://thelearnquesters.pages.dev/sprunki-space-challenge.html)
- [TATTOO MASTER](https://thelearnquesters.pages.dev/tattoo-master.html)
- [CINEMA EMPIRE IDLE TYCOON](https://thelearnquesters.pages.dev/cinema-empire-idle-tycoon.html)
- [SHOP SORTING 2](https://theskillquest.pages.dev/shop-sorting-2.html)
...
- [INDEX12](https://iskillquest.pages.dev/index12.html)
...
- [CATEGORY MISSION207](https://iskillquest.pages.dev/category-mission207.html)
- [DYNAMONS 12](https://studyplaying.github.io/dynamons-12.html)
...
- [FRUIT JAM MASTER](https://iskillquest.pages.dev/fruit-jam-master.html)
...
- [100 DOORS CHALLENGE](https://thelearnquesters.pages.dev/100-doors-challenge.html)
- [ARROW SHIFT LOGIC TREE](https://thelearnquester.web.app/arrow-shift-logic-tree.html)
- [TAP GO DELUXE](https://themindplaying.web.app/tap-go-deluxe.html)
- [COLOR MIX JELLY MERGE](https://studyplaying.github.io/color-mix-jelly-merge.html)
- [ITALIAN ANIMALS CREATE YOUR OWN BRAINROT](https://studyplaying.github.io/italian-animals-create-your-own-brainrot.html)
- [CATEGORY DRAWING GAME](https://themindplays.pages.dev/category-drawing-game.html)
...
- [NUTS BOLTS SCREW GLASS](https://theskillquest.pages.dev/nuts-bolts-screw-glass.html)
...
- [MATH QUEST](https://themindplaying.web.app/math-quest.html)
