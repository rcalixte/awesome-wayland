...
- ![Zig](https://img.shields.io/badge/zig-%23f7a41d.svg?style=plastic&logo=zig&logoColor=fff) [rswlsr](https://codeberg.org/pparaxan/rswlsr) - A simple screen recorder for Wayland compositors implementing the `ext-image-capture-source-v1`, `ext-image-copy-capture-v1`, and `xdg-output-unstable-v1` protocols
...
- ![Rust](https://img.shields.io/badge/rust-%23281c1c.svg?style=plastic&logo=rust&logoColor=fff) [rayshot](https://github.com/paranoica/rayshot) - A fast, Lightshot-style screenshot and annotation tool for GNOME/Wayland, using xdg-desktop-portal and PipeWire with a resident daemon for instant capture
