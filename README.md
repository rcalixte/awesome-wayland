...
- ![Python](https://img.shields.io/badge/python-4584b6?style=plastic&logo=python&logoColor=ffde57) [vocalinux](https://github.com/jatinkrmalik/vocalinux) - Offline system-wide voice dictation for Linux with Wayland and X11 text injection support (local whisper.cpp / Whisper / VOSK models)
