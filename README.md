...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [diowmenu](https://github.com/DiogenesN/diowmenu) - A simple GUI menu application for quickly acessing your favorite applicaitons in a wlroots-based Wayland compositors supporting the wlr-layer-shell-unstable-v1 protocol
