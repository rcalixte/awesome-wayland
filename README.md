...
- ![Rust](https://img.shields.io/badge/rust-%23281c1c.svg?style=plastic&logo=rust&logoColor=fff) [waylauncher](https://github.com/topekodev/waylauncher) - A GTK-based application launcher implementing the `gtk4-layer-shell` protocol
