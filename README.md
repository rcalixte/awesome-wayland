...
- ![QML](https://img.shields.io/badge/qml-%2341cd52.svg?style=plastic&logo=qt&logoColor=fff) [Quay](https://github.com/lunanoir21/quickshell-quay) - A vertical, home-screen-style app launcher rail for Quickshell implementing the `wlr-layer-shell-unstable-v1` protocol
