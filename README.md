...
- ![Bash](https://img.shields.io/badge/bash-%23281c.svg?style=plastic&logo=GNU%20Bash&logoColor=fff) [botspot-screen-recorder](https://github.com/Botspot/botspot-screen-recorder) - A GUI frontend for wf-recorder with support for mutltiple Pipewire audio sources and optional webcam capture, for wlroots-based compositors (more specifically, those that support `wlr-screencopy-unstable-v1` and `xdg-output-unstable-v1`)
