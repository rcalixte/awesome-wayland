...
- ![Rust](https://img.shields.io/badge/rust-%23281c1c.svg?style=plastic&logo=rust&logoColor=fff) [shotdock](https://github.com/sirrryasir/shotdock) - Automated window framing, soft drop shadows, screen recording, and studio capture for Wayland compositors, implementing the `gtk4-layer-shell` protocol
