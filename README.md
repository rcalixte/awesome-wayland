...
- ![C](https://img.shields.io/badge/c-%23044f88.svg?style=plastic&logo=c&logoColor=fff) [EasyGamma](https://github.com/Jahamars/easygamma) - A simple GUI to control display gamma on Wayland (wlroots compositors supporting `wlr-gamma-control-unstable-v1`), with presets, RGB sliders, and multi-monitor support
